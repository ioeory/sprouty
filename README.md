...
- **多账本**：个人 / 家庭账本，通过邀请码共享；家庭账本可 **关联个人子账本**（成员与共享页管理），侧边栏以树形展示，仪表盘可 **汇总** 家庭 + 你有权访问的已关联私账支出
...
- **饼图分析**：按分类 / 项目 / 账本维度查看支出分布，支持年/月/全部时间；当前账本为家庭且含子账关联时，汇总口径与「仅家庭账」预算对齐说明见下文
...
- **仪表盘**：选中家庭账且存在可访问的子账关联时，**支出与饼图**会汇总「家庭 + 这些子账」；**本月总预算**仍只读 **家庭账本** 上设置的月度总预算（不把多个私账预算相加）。需要看纯家庭流水时，仍只统计家庭账本本身上的交易。
